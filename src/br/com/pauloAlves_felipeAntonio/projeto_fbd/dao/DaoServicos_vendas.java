...
public class DaoServicos_vendas implements IDaoServicos_vendas{
	...
	public void salvar(Servicos_vendas servico) throws DaoException {
		try {
			...
			statement = conexao.prepareStatement(SQLUtil.Servicos_vendas.INSERT_ALL);
			 
			statement.setInt(1,servico.getId_vendas());
			statement.setInt(2,servico.getId_servicos());
			statement.setInt(3,servico.getId_produtos());
